  ...
  <div class="flex h-full">
    ...
    <aside class="w-64 bg-white shadow-2xl flex flex-col p-4 hidden md:block">
      ...
      <nav class="flex flex-col gap-4">
        ...
        <a href="student.profile.index" class="block py-2 px-4 rounded-xl text-lg font-medium hover:bg-blue-200 transition">
          Meu Perfil
        </a>
        <a href="student.responsible.index" class="block py-2 px-4 rounded-xl text-lg font-medium hover:bg-blue-200 transition">
          Responsáveis
        </a>
      </nav>
    </aside>
