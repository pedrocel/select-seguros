                        ...
                        <div class="w-full lg:w-4/5 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                            ...
                            <div class="rounded-lg shadow p-4
                                ...
                                <p class="text-gray-700 dark:text-gray-300">
                                    @if($user->status == 1)
                                        <span class="text-yellow-500">Pendente de enviar o facial e de enviar todos os documentos</span>
                                    @elseif($user->status == 2)
                                        <span class="text-yellow-500">Pendente de enviar os documentos</span>
                                    @elseif($user->status == 3)
                                        <span class="text-yellow-500">Pendente de enviar o facial</span>
                                    @elseif($user->status == 4)
...
<div id="userModal" class="fixed inset-0 flex items-center justify-center z-14 hidden bg-black bg-opacity-50">
