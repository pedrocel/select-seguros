    ...
    <div id="sidebar" class="w-64 bg-[#1a1a1a] border-r border-gray-800 flex flex-col fixed h-full z-40 sidebar-transition md:relative md:translate-x-0">
      ...
      <div class="flex-1 overflow-y-auto py-4">
        <nav class="px-2 space-y-1">
            ...
            <a href="{{ route('cliente.dashboard') }}" class="sidebar-item flex items-center px-4 py-3 text-gray-300 rounded-lg hover:bg-gray-800 {{ request()->routeIs('cliente.dashboard') ? 'active' : 'text-white' }}">
                <i class="fas fa-chart-line w-5 h-5 mr-3"></i>
                <span class="text-sm font-medium">DASHBOARD</span>
            </a>

            <a href="{{ route('cliente.apolices') }}" class="sidebar-item flex items-center px-4 py-3 text-gray-300 rounded-lg hover:bg-gray-800 {{ request()->routeIs('cliente.apolices') ? 'active' : 'text-white' }}">
                <i class="fas fa-file-contract w-5 h-5 mr-3"></i>
                <span class="text-sm font-medium">MINHAS APÓLICES</span>
            </a>

            <a href="{{ route('cliente.relatorios') }}" class="sidebar-item flex items-center px-4 py-3 text-gray-300 rounded-lg hover:bg-gray-800 {{ request()->routeIs('cliente.relatorios') ? 'active' : 'text-white' }}">
                <i class="fas fa-chart-bar w-5 h-5 mr-3"></i>
                <span class="text-sm font-medium">OCORRÊNCIAS</span>
            </a>

            <a href="{{ route('cliente.vendas') }}" class="sidebar-item flex items-center px-4 py-3 text-gray-300 rounded-lg hover:bg-gray-800 {{ request()->routeIs('cliente.vendas') ? 'active' : 'text-white' }}">
            ...
            <a href="{{ route('cliente.minha-conta') }}" class="sidebar-item flex items-center px-4 py-3 text-gray-300 rounded-lg hover:bg-gray-800 {{ request()->routeIs('cliente.minha-conta') ? 'active' : 'text-white' }}">
